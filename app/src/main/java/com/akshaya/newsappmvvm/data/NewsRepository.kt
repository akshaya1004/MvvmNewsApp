package com.akshaya.newsappmvvm.data

import androidx.paging.Pager
import androidx.paging.PagingConfig
import androidx.paging.PagingData
import androidx.room.withTransaction
import com.akshaya.newsappmvvm.api.NewsApi
import com.akshaya.newsappmvvm.utils.Resource
import com.akshaya.newsappmvvm.utils.networkBoundResource
    ...
    fun getBreakingNews(
        ...
        networkBoundResource(
            ...
            fetch = {
                ...
                return@networkBoundResource response.articles
            },
